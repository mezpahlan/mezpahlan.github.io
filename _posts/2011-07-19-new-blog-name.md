...
{% picture {{ page.id }}/haters.jpg alt="Haters Gonna Hate" %}

<!-- more -->

What prompted this decision is the discovery of another tech blog with pretty much the same name! And this dude posts a lot more than me. So screw it I'll change.
I was thinking something snappy and fun with my name in it. Something like: the middle tier (yes that is sad and yes I do work in middleware). But I also blog about random stuff. Film, music, cooking etc etc.

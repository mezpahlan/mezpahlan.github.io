...
I need to focus and finish this project off and then........ well then I'm out of here. Gone. Vanished! Into the ether. Well a two week holiday anyway.

Things I still need to do:

1. Hack Wii to make it a media centre. I am fed up of watching stuff on my computer when I can stream it to my projector.
...
{% responsive_image_block %}
    path: {{ site.responsive_image.base_path | append: page.id | remove_first: "#excerpt" | append: "/the-beautiful-rosine.jpg" }}
    alt: "The Beautiful Rosine"

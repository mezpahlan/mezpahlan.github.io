...
I'm still watching them now. On to season 2. I've made my self some shandy and am currently sipping it watching the rest of the season.

<!-- more -->

I've set my self a target of downloading every single disney movie since the 1930s. There is a [list](http://en.wikipedia.org/wiki/List_of_Disney_feature_films) from wikipedia and I am using a usenet service to "source" them.
...
{% picture {{ page.id }}/quarrel.jpg alt="The Quarrel Of Slop And Susannah" %}

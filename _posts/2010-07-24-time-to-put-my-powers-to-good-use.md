...
4. My IDE of choice Eclipse has troubles with OpenJDK thus I must use the Sun version. I have no issues against that, but Sun (now SnOracle) don't do a 64 bit version of their JDK :(  

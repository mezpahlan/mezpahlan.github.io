...
{% picture {{ page.id }}/htc-desire.jpg alt="HTC Desire" %}
...
Why can't I cherry pick the manifesto pledges that I like?
Why can't can't I also cherry pick the politicians I like?
...
{% picture {{ page.id }}/libdem.jpg alt="Liberal Democrats" %}

...
{% responsive_image_block %}
    path: {{ site.responsive_image.base_path | append: page.id | remove_first: "#excerpt" | append: "/snowboarding.jpg" }}
    alt: "Snowboarding"
...
I've taken the controversial decision to not wear goggles. UV contact lenses. UV400!!! Is that not enough? Worked fine for me last time. Mind you didn't snow last time.

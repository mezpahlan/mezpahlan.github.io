...
{% responsive_image_block %}
    path: {{ site.responsive_image.base_path | append: page.id | remove_first: "#excerpt" | append: "/wedding-day.jpg" }}
    alt: "Wedding Day"
...
Butter nut squash followed by gin and tonic sorbet. Nice. Next up the steak!
Oh the steak was so good! Irish rump steak with one potato no sauce. Simply the steak. Divine!

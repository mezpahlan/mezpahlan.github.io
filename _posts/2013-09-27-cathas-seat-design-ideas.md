...
{% responsive_image_block %}
    path: {{ site.responsive_image.base_path | append: page.id | remove_first: page.category | replace_first: "//", "/" | remove_first: "#excerpt" | append: "/start_activity.png" }}
    alt: "Start Activity"
...
2. Pressing the Go button takes you to the next screen - the map.
 ...
 {% responsive_image_block %}
    path: {{ site.responsive_image.base_path | append: page.id | remove_first: page.category | replace_first: "//", "/" | remove_first: "#excerpt" | append: "/map_activity.png" }}
    alt: "Map Activity"
{% endresponsive_image_block %}
...
3. The route will lead to a marker for Catha's Seat.
 ...
 {% responsive_image_block %}
    path: {{ site.responsive_image.base_path | append: page.id | remove_first: page.category | replace_first: "//", "/" | remove_first: "#excerpt" | append: "/directions_activity.png" }}
...
{% responsive_image_block %}
    path: {{ site.responsive_image.base_path | append: page.id | remove_first: page.category | replace_first: "//", "/" | remove_first: "#excerpt" | append: "/interaction.png" }}
    alt: "Interaction"
{% endresponsive_image_block %}

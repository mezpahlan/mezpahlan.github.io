...
I'll talk more about it later on in the year, I'm sure, but for now I wanted to prepare myself by eyeing out three gadgets to take with me to make the trip a truly fantastic experience. Note, I could probably just take nothing and it will be cool, but I'm pretty geeky so I can't resist!
...
{% picture {{ page.id }}/x100.jpg alt="Fuji X-100" %}
...
{% picture {{ page.id }}/transformer.jpg alt="Asus Transformer" %}
...
{% picture {{ page.id }}/galaxy-s3.jpg alt="Samsung Galaxy S3" %}
